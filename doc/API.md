...
Once you know which version of CartoDB.js you're using, you can point your site to that release. If the current version of CartoDB.js is 3.15.8-skytruth-4, the URL would be:

```html
<script src="http://libs.cartocdn.com/cartodb.js/v3/3.15.8-skytruth-4/cartodb.js"></script>
```

You can do the same for the CSS documents we provide:

```html
<link rel="stylesheet" href="http://libs.cartocdn.com/cartodb.js/v3/3.15.8-skytruth-4/themes/css/cartodb.css" />
```

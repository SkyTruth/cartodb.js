...
```
git flow release start 3.15.8-skytruth-3
```
...
```
git commit -am "Files changed for version 3.15.8-skytruth-3"
```
...
```
http://libs.cartocdn.com.s3.amazonaws.com/cartodb.js/v3/3.15.8-skytruth-3/cartodb.js
http://libs.cartocdn.com/cartodb.js/v3/3.15.8-skytruth-3/cartodb.js
...
```
git flow release finish 3.15.8-skytruth-3
git push --all
git push --tags
```
...
For example, if we are in 3.15.8-skytruth-3 and we want to go back to 3.13.4
